...
class KkMainAsetPerkebunan extends Entity
{
	...
	public function get_jenis_komoditas_string(){

			$skm_model = new KomoditasPerkebunanModel();
			$skm_ent = $skm_model->find($this->attributes['jenis_komoditas']);
			return $skm_ent->nama_komoditas_perkebunan;
	}
