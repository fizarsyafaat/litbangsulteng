...
class KkMainAsetTanamanPangan extends Entity
{
	...
	public function get_luas_panen_pangan_string(){
	...
	public function get_jumlah_produksi_pangan_string(){
	...
	public function get_jumlah_pohon_pangan_string(){
	...
	public function get_jenis_bibit_pangan_string(){
	...
	public function get_pestisida_pangan_string(){
	...
	public function get_pupuk_organik_pangan_string(){
	...
	public function get_pupuk_pabrik_pangan_string(){
	...
	public function get_hasil_pemasaran_pangan_string(){
