...
class KkMainAsetKehutanan extends Entity
{
	...
	public function get_jenis_komoditas_kehutanan_string(){

			$skm_model = new KomoditasKehutananModel();
			$skm_ent = $skm_model->find($this->attributes['jenis_komoditas']);
			return $skm_ent->nama_komoditas_kehutanan;
	}

	public function get_luas_panen_kehutangan_string(){
	...
	public function get_jumlah_produksi_kehutangan_string(){
	...
	public function get_jumlah_pohon_kehutangan_string(){
	...
	public function get_jenis_bibit_kehutangan_string(){
	...
	public function get_pestisida_kehutangan_string(){
	...
	public function get_pupuk_organik_kehutangan_string(){
	...
	public function get_pupuk_pabrik_kehutangan_string(){
	...
	public function get_hasil_pemasaran_kehutangan_string(){
