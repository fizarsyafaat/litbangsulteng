								    	...
								    	<div class="row">
								    		<div class="col-12">
								    			<div class="form-group">
								    				...
								    				<div class="row">
								    					<div class="col-sm-6">
								    						<p class="nama_pendata">Tidak Ada</p>
								    					</div>
								    				</div>
								    			</div>
								    			<div class="form-group">
								    				...
								    				<div class="row">
								    					<div class="col-sm-6">
								    						<p class="pekerjaan_pendata">Tidak Ada</p>
								    					</div>
								    				</div>
								    			</div>
								    			<div class="form-group">
								    				...
								    				<div class="row">
								    					<div class="col-sm-6">
								    						<p class="jabatan_pendata">Tidak Ada</p>
								    					</div>
								    				</div>
								    			</div>
								    			<div class="form-group">
								    				...
								    				<div class="row">
								    					<div class="col-sm-6">
								    						<p class="sumber_data">Tidak Ada</p>
								    					</div>
								    				</div>
								    			</div>
								    			<div class="form-group">
								    				...
								    				<div class="row">
								    					<div class="col-sm-6">
								    						<p class="no_handphone">Tidak Ada</p>
								    					</div>
								    				</div>
								    			</div>
								    		</div>
								    	...
								    	<div class="row">
								    		<div class="col-12">
								    			<div class="form-group">
								    				...
								    				<div class="row">
								    					<div class="col-sm-6">
								    						<p class="jumlah_aktivitas_wisata_bulanan">Tidak Ada</p>
								    					</div>
								    				</div>
								    			</div>
								    				<div class="form-group">
								    				...
								    				<div class="row">
								    					<div class="col-sm-6">
								    						<p class="jumlah_biaya_wisata_bulanan">Tidak Ada</p>
								    					</div>
								    				</div>
								    			</div>
								    				<div class="form-group">
								    				...
								    				<div class="row">
								    					<div class="col-sm-6">
								    						<p class="lokasi_objek_wisata">Tidak Ada</p>
								    					</div>
								    				</div>
								    			</div>
								    				<div class="form-group">
								    				...
								    				<div class="row">
								    					<div class="col-sm-6">
								    						<p class="daya_tarik_wisata_palu">Tidak Ada</p>
								    					</div>
								    				</div>
								    			</div>
								    				<div class="form-group">
								    				...
								    				<div class="row">
								    					<div class="col-sm-6">
								    						<p class="pengelolaan_pariwisata_palu">Tidak Ada</p>
								    					</div>
								    				</div>
								    			</div>
								    		</div>
								    	...
								    	<div class="row">
								    		<div class="col-12">
								    			<div class="form-group">
								    				...
								    				<div class="row">
								    					<div class="col-sm-6">
								    						<p class="acceptorkb_multi">Tidak Ada</p>
								    					</div>
								    				</div>
								    			</div>
								    			<div class="form-group">
								    				...
								    				<div class="row">
								    					<div class="col-sm-6">
								    						<p class="kualitas_ibu_hamil">Tidak Ada</p>
								    					</div>
								    				</div>
								    			</div>
								    				<div class="form-group">
								    				...
								    				<div class="row">
								    					<div class="col-sm-6">
								    						<p class="kualitas_bayi">Tidak Ada</p>
								    					</div>
								    				</div>
								    			</div>
								    				<div class="form-group">
								    				...
								    				<div class="row">
								    					<div class="col-sm-6">
								    						<p class="tempat_persalinan">Tidak Ada</p>
								    					</div>
								    				</div>
								    			</div>
								    				<div class="form-group">
								    				<div class="row">
								    					...
								    					<div class="row">
								    					<div class="col-sm-6">
								    						<p class="cakupan_imunisasi_multi">Tidak Ada</p>
								    					</div>
								    				</div>
								    			</div>
								    				<div class="form-group">
								    				...
								    				<div class="row">
								    					<div class="col-sm-6">
								    						<p class="pertolongan_persalinan">Tidak Ada</p>
								    					</div>
								    				</div>
								    			</div>
								    				<div class="form-group">
								    				...
								    				<div class="row">
								    					<div class="col-sm-6">
								    						<p class="fasilitas_layanan_kesehatan">Tidak Ada</p>
								    					</div>
								    				</div>
								    			</div>
								    			<div class="form-group">
								    				...
								    				<div class="row">
								    					<div class="col-sm-6">
								    						<p class="jenis_kelamin_balita">Tidak Ada</p>
								    					</div>
								    				</div>
								    			</div>
								    			<div class="form-group">
								    				...
								    				<div class="row">
								    					<div class="col-sm-6">
								    						<p class="umur_balita">Tidak Ada</p>
								    					</div>
								    				</div>
								    			</div>
								    			<div class="form-group">
								    				...
								    				<div class="row">
								    					<div class="col-sm-6">
								    						<p class="berat_badan">Tidak Ada</p>
								    					</div>
								    				</div>
								    			</div>
								    			<div class="form-group">
								    				...
								    				<div class="row">
								    					<div class="col-sm-6">
								    						<p class="tinggi_badan">Tidak Ada</p>
								    					</div>
								    				</div>
								    			</div>
								    			<div class="form-group">
								    				...
								    				<div class="row">
								    					<div class="col-sm-6">
								    						<p class="kondisi_saat_pengukuran">Tidak Ada</p>
								    					</div>
								    				</div>
								    			</div>
								    			<div class="form-group">
								    				...
								    				<div class="row">
								    					<div class="col-sm-6">
								    						<p class="status_gizi_balita">Tidak Ada</p>
								    					</div>
								    				</div>
								    			</div>
								    			</div>
								    	...
								    	<div class="row">
								    		<div class="col-12">
								    			<div class="form-group">
								    				...
								    				<div class="row">
								    					<div class="col-sm-6">
								    						<p class="penderita_sakit_kelainan">Tidak Ada</p>
								    					</div>
								    				</div>
								    			</div>
								    				<div class="form-group">
								    				...
								    				<div class="row">
								    					<div class="col-sm-6">
								    						<p class="perilaku_hidup_bersih">Tidak Ada</p>
								    					</div>
								    				</div>
								    			</div>
								    				<div class="form-group">
								    				...
								    				<div class="row">
								    					<div class="col-sm-6">
								    						<p class="pola_makan">Tidak Ada</p>
								    					</div>
								    				</div>
								    			</div>
								    				<div class="form-group">
								    				...
								    				<div class="row">
								    					<div class="col-sm-6">
								    						<p class="kebiasaan_berobat">Tidak Ada</p>
								    					</div>
								    				</div>
								    			</div>
								    				<div class="form-group">
								    				...
								    				<div class="row">
								    					<div class="col-sm-6">
								    						<p class="jenis_penyakit">Tidak Ada</p>
								    					</div>
								    				</div>
								    			</div>
								    		</div>
								    	...
								    	<div class="row">
								    		<div class="col-12">
								    			<div class="form-group">
								    				...
								    				<div class="row">
								    					<div class="col-sm-6">
								    						<p class="col-sm-12 transportasi_umum_multi">Tidak Ada</p>
								    					</div>
								    				</div>
								    			</div>
								    				<div class="form-group">
								    				...
								    				<div class="row">
								    					<div class="col-sm-6">
								    						<p class="col-sm-12 lembaga_pendidikan_multi">Tidak Ada</p>
								    					</div>
								    				</div>
								    			</div>
								    				<div class="form-group">
								    				...
								    				<div class="row">
								    					<div class="col-sm-6">
								    						<p class="col-sm-12 aset_produksi_multi">Tidak Ada</p>
								    					</div>
								    				</div>
								    			</div>								    				
								    		</div>
								    	...
								    	<div class="row">
								    		<div class="col-12">
								    			<div class="form-group">
								    				...
								    				<div class="row">
								    					<div class="col-sm-6">
								    						<p class="sumber_air_minum">Tidak Ada</p>
								    					</div>
								    				</div>
								    			</div>
								    			<div class="form-group">
								    				...
								    				<div class="row">
								    					<div class="col-sm-6">
								    						<p class="ket_sumber_air_minum">Tidak Ada</p>
								    					</div>
								    				</div>
								    			</div>
								    			<div class="form-group">
								    				...
								    				<div class="row">
								    					<div class="col-sm-6">
								    						<p class="status_kepemilikan_rumah">Tidak Ada</p>
								    					</div>
								    				</div>
								    			</div>
								    			<div class="form-group">
								    				...
								    				<div class="row">
								    					<div class="col-sm-6">
								    						<p class="sarana_mck">Tidak Ada</p>
								    					</div>
								    				</div>
								    			</div>
								    				...
								    				<div class="row">
								    					<div class="col-sm-6">
								    						<p class="daya_listrik">Tidak Ada</p>
								    					</div>
								    				</div>
								    			</div>
								    			<div class="form-group">
								    				...
								    				<div class="row">
								    					<div class="col-sm-6">
								    						<p class="luas_pekarangan_rumah">Tidak Ada</p>
								    					</div>
								    				</div>
								    			</div>
								    				...
								    				<div class="row">
								    					<div class="col-sm-6">
								    						<p class="pemanfaatan_danau_dkk">Tidak Ada</p>
								    					</div>
								    				</div>
								    			</div>
								    				<div class="form-group">
								    				...
								    				<div class="row">
								    					<div class="col-sm-6">
								    						<p class="dinding_rumah">Tidak Ada</p>
								    					</div>
								    				</div>
								    			</div>
								    				<div class="form-group">
								    				...
								    				<div class="row">
								    					<div class="col-sm-6">
								    						<p class="atap_rumah">Tidak Ada</p>
								    					</div>
								    				</div>
								    			</div>
								    				<div class="form-group">
								    				...
								    				<div class="row">
								    					<div class="col-sm-6">
								    						<p class="lantai_rumah">Tidak Ada</p>
								    					</div>
								    				</div>
								    			</div>
											</div>
