        ...
        <div id="dashboard" class="content-wrapper" meta-id="0">
            ...
            <div class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <h1 class="m-0">Grafik Tanaman Pangan & Tanaman Obat Masyarakat di Kota Palu</h1>
                        </div>
                        <!-- /.col -->
                        <div class="col-sm-6">
                            <ol class="breadcrumb float-sm-right">
                                <li class="breadcrumb-item"><a href="#">Pertanian</a></li>
                                <li class="breadcrumb-item active">Grafik Pertanian</li>
                            </ol>
                        </div>
                        <!-- /.col -->
                    </div>
                                ...
                                <div class="card card-primary card-outline">
                                    <div class="card-header">
                                        <h3 class="card-title">
                                            ...
                                            Tanaman Pangan Masyarakat di Kota Palu (Grafik)
                                        </h3>
