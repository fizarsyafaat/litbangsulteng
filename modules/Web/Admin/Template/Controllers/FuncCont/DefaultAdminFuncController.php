...
use BusinessProcessRoot\Entities\Misc\Pagination as PaginationEntity;
...
class DefaultAdminFuncController extends FuncController{
	...
	public function json_pagination($page_now,$total_data,$data_per_page){
		$config = array(
		...
		return $this->master_pagination($config)->renderPagerJson();
	}

	public function master_pagination($config){
		//total_halaman
