$(document).ready(function(){
	...
	function get_komoditas1(){
		...
		var kecamatan_id = $(".all-districts-produksi").find(":selected").attr("value");
		var kelurahan_id = $(".all-subdistricts-produksi").find(":selected").attr("value");
	...
	$(".all-districts-produksi").on("change",function(){
		get_kelurahan_produksi();
	});

	function get_kelurahan_produksi(){
		var kecamatan_id = $(".all-districts-produksi").find(":selected").attr("value");
		var page_csrf = $(".csrf-header-master").attr("name");
		var page_csrf_value = $(".csrf-header-master").attr("value");
		...
		$.post(config_url + "panel/address/json/get-subdistrict/"+kecamatan_id,data,function(rd){
			...
			$(".all-subdistricts-produksi").html(text);
		},"json")
		.fail(function(rd){
			console.log(rd);
			Toast.fire({
	...
	$(".filter-produksi").on("click",function(){
		get_komoditas1();
	});
